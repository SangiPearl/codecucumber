...
@CucumberOptions(features = "Script.feature", glue ="com.StepDefinition.com",
		 strict = true,
monochrome=true,plugin={"json:target/cucumber-reports/Cucumber.json","html:html-report","com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}
)		
